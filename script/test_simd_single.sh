...
# Usage: ./test_simd_single.sh [emon]
...
tail -4 results.csv | awk -F',' '{
    printf "%-8s: %7.2f Mops/s | %5.2f°C | %4.0f MHz | %.2fM ops total\n", 
    $5, $14, $11, $12, $13
}'
echo ""
echo "Comparison:"
...
BEGIN { print "----------|---------|----------|--------|------" }
NR==1 { sse=$14; printf "%-9s | %7.2f | baseline | %5.2f°C | %4.0f MHz\n", $5, $14, $11, $12 }
NR==2 { printf "%-9s | %7.2f | %+6.2f%% | %5.2f°C | %4.0f MHz\n", $5, $14, ($14-sse)/sse*100, $11, $12 }
NR==3 { printf "%-9s | %7.2f | %+6.2f%% | %5.2f°C | %4.0f MHz\n", $5, $14, ($14-sse)/sse*100, $11, $12 }
NR==4 { printf "%-9s | %7.2f | %+6.2f%% | %5.2f°C | %4.0f MHz\n", $5, $14, ($14-sse)/sse*100, $11, $12 }
'
echo ""
